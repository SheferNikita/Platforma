...
- 13.01.2026: Улучшения раздела "Мини-группы"
  - Куратор выбирается из выпадающего списка контактов (связь MiniGroup → Contact через curatorId)
  - Удалены поля maxMembers и schedule из формы создания
  - Добавлено поле chatLink для ссылки на чат группы
  - Автопубликация мини-групп при создании (isPublished: true)
  - Страница настроек мини-группы с редактированием chatLink и просмотром связанных событий
  - После создания группы автоматически открывается окно настроек
  - События расписания можно привязать к мини-группе (ScheduleEvent.miniGroupId)
  - Публичный API возвращает данные куратора и связанных событий
