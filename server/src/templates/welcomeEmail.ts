          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 30px; color: #3d3527; font-size: 16px; line-height: 1.6;">
                Ваш личный кабинет на обучающей платформе создан. Ниже вы найдёте данные для входа.
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                    <a href="${data.loginUrl}" style="display: inline-block; background: linear-gradient(135deg, #a67c52 0%, #c4a57b 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 12px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 12px rgba(166, 124, 82, 0.3);">
